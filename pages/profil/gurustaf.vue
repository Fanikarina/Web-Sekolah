            ...
            <div class="col-12 d-flex justify-content-center mt-5">
                <div class="card shadow" style="width: 15rem;">
                    <div class="card-body">
                        ...
                        <p class="card-text text-center text-white">Total Guru / Pendidik</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="guru">
                <div class="row layer mt-5">
                    <div class="judul text-center mt-5">
                        ...
                        <p class="card-text"><small class="text-muted">SMK Negeri 4 Tasikmalaya</small></p>
                    </div>
                    <div class="col-2">
                        <div class="card">
            ...
            <div class="guru2">
                <div class="row layer2 mt-5">
                    <div class="judul text-center text-white mt-5">
                        ...
                        <p class="card-text"><small class="text-white">SMK Negeri 4 Tasikmalaya</small></p>
                    </div>
                    <div class="col-2">
                        <div class="card">
                            <img src="~/assets/img/logo.png" alt="">
