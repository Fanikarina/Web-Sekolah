  ...
  <div class="container text-white">
    <div class="row d-flex justify-content-center p-5">
      ...
      <div class="col-3 linkLainnya">
        ...
        <ul class="list-group">
          ...
          <a href="https://dapo.dikdasmen.kemdikbud.go.id/" target="_blank"
            >Dapodiknasmen</a
          >
          <a href="https://psmk.kemdikbud.go.id/" target="_blank">PSMK</a>
          <a href="https://disdik.jabarprov.go.id/" target="_blank"
            >Disdik Jabar</a
          >
        </ul>
      </div>
      <div class="col-2 Medsos">
        ...
        <hr />
        <div class="facebook">
          <a href="https://www.facebook.com/4smkn" class="d-flex gap-2"
            ><svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
        ...
        <div class="twit">
          <a href="https://x.com/4smkn " class="d-flex gap-2"
            ><svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
    ...
    <div class="row">
      <div class="col">
        <hr />
        <p class="text-center">
          © 2024 . SMK Negeri 4 Tasikmalaya. <br />
          All rights reserved.
        </p>
        <hr />
      </div>
